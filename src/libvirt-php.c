...
PHP_MINIT_FUNCTION(libvirt)
{
    ...
    REGISTER_LONG_CONSTANT("VIR_DOMAIN_SHUTDOWN_DEFAULT", VIR_DOMAIN_SHUTDOWN_DEFAULT, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("VIR_DOMAIN_SHUTDOWN_ACPI_POWER_BTN", VIR_DOMAIN_SHUTDOWN_ACPI_POWER_BTN, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("VIR_DOMAIN_SHUTDOWN_GUEST_AGENT", VIR_DOMAIN_SHUTDOWN_GUEST_AGENT, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("VIR_DOMAIN_SHUTDOWN_INITCTL", VIR_DOMAIN_SHUTDOWN_INITCTL, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("VIR_DOMAIN_SHUTDOWN_SIGNAL", VIR_DOMAIN_SHUTDOWN_SIGNAL, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("VIR_DOMAIN_SHUTDOWN_PARAVIRT", VIR_DOMAIN_SHUTDOWN_PARAVIRT, CONST_CS | CONST_PERSISTENT);
